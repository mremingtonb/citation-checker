...
<div class="container">
  <header>
    ...
    <p>This webpage will attempt to determine if a legal brief is AI generated by checking for the existence of citations contained within the brief.</p>
    <p>Upload a legal brief (.docx or .pdf) to verify case law citations</p>
